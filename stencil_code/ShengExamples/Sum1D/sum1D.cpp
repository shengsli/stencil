/**
 * g++ sum1D.cpp -std=c++11 -O2 -lpthread -DRADIUS=2 -DNTHREADS=4 -DNITEMS=1024 -DNITERS=10 -DNDATABLOCKS=100 -DPADDING=0 -DOUTPUT -o sum1D
 * ./sum1D
 */
