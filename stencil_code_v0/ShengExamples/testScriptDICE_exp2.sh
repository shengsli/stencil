...
./sum2DScript_exp2 4 100 5 sum2DresultDICE_exp2.csv 3 8 8 0 20
echo "Sum2D test done"

cd ~/stencil/stencil_code_v0/ShengExamples/Median2D
./median2DScript_exp2 4 100 5 median2DresultDICE_exp2.csv 3 8 8 0 20
echo "Median2D test done"

cd ~/stencil/stencil_code_v0/ShengExamples/GaussianBlur2D
./gaussianBlur2DScript_exp2 4 100 5 gaussianBlur2DresultDICE_exp2.csv 2 8 8 0 20
echo "GaussianBlur2D test done"

cd ~/stencil/stencil_code_v0/ShengExamples/HeatTransfer2D
./heatTransfer2DScript_exp2 4 100 5 heatTransfer2DresultDICE_exp2.csv 1 8 8 0 20
echo "HeatTransfer2D test done"

cd ~/stencil/stencil_code_v0/ShengExamples/Sum3D
./sum3DScript_exp2 4 100 5 sum3DresultDICE_exp2.csv 1 4 4 4 0 20
echo "Sum3D test done"

cd ~/stencil/stencil_code_v0/ShengExamples/Median3D
./median3DScript_exp2 4 100 5 median3DresultDICE_exp2.csv 1 4 4 4 0 20
