/**
 * g++ returnInt.cpp -std=c++11 -O2 -lpthread -DRADIUS=2 -DNTHREADS=4 -DNITEMS=1024 -DNDATABLOCKS=100 -DOUTPUT -o returnInt
 * ./returnInt
 */
...
int main(int argc, char** argv) {
    ...
    auto stencil = Stencil1D(stencilkernel, RADIUS, WRAP_AROUND, 1, NTHREADS);
    stencil(out, in);
